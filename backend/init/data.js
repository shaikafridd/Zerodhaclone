const holdings = [
  { name: "BHARTIARTL", qty: 2, avg: 538.05, price: 541.15, net: "+5.89%", day: "+2.99%" },
...
const positions = [
  { product: "CNC", name: "EUREKA", qty: 2, avg: 316.27, price: 312.35, net: "+0.58%", day: "-1.24%", isLoss: true },
  { product: "CNC", name: "INCAB", qty: 2, avg: 3.16, price: 3.0, net: "+0.58%", day: "-5.06%", isLoss: true },
];
...
const watchlist = [
  ...
  { name: "SBIN", price: 430.20, percent: "-0.34%", isDown: true },
  { name: "WIPRO", price: 577.75, percent: "+0.32%", isDown: false },
  { name: "TATAMOTORS", price: 334.15, percent: "-1.20%", isDown: true },
  { name: "BHARTIARTL", price: 541.15, percent: "+2.99%", isDown: false },
  { name: "ITC", price: 207.90, percent: "+0.80%", isDown: false },
];

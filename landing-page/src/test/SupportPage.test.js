...
describe('SupportPage and its Subcomponents', () => {
    test('renders Support Hero component successfully', () => {
        ...
        expect(screen.getByRole('link', { name: /Aero user manual/i })).toBeInTheDocument();
    ...
    test('renders Ticket component successfully', () => {
        ...
        expect(screen.getByRole('heading', { name: /Your Aero Account/i })).toBeInTheDocument();
        ...
        expect(screen.getByRole('heading', { name: /Aero Coin/i })).toBeInTheDocument();
        ...
        expect(screen.getByRole('link', { name: /Understanding mutual funds and Aero Coin/i })).toBeInTheDocument();
    });

            ...
            <div className='row p-5 align-items-center'>
                <div className='col-12 col-md-6 p-3 p-md-5'>
                    ...
                    <p className='text-muted mb-4'>
                        That's why 1.6+ crore customers trust Echo with ~ ₹6 lakh crores of equity investments, making us India’s largest broker; contributing to 15% of daily retail exchange volumes in India.
                    </p>
                    ...
                    <h2 className='fs-4 fw-medium'>The Echo universe</h2>
                    <p className='text-muted mb-4'>
                ...
                <div className='col-12 col-md-6 p-3 p-md-5 text-center'>
                    ...
                    <div className='text-center d-flex flex-column flex-md-row justify-content-center align-items-center gap-3'>
                        ...
                        <Link to='/signup' className='text-primary fw-medium' style={{ textDecoration: "none" }}>Try Echo Demo <i className="fa-solid fa-arrow-right"></i></Link>
                    </div>
                </div>
            </div>
        </div>

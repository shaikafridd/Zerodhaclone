        ...
        <div className='container p-3'>
            <div className='row p-5 align-items-center'>
                <div className='col-12 col-md-6 p-3 p-md-5'>
                    ...
                    <h2 className='fs-4 fw-medium'>The Zerodha universe</h2>
                    <p className='text-muted mb-4'>
                ...
                <div className='col-12 col-md-6 p-3 p-md-5 text-center'>
                    ...
                    <div className='text-center d-flex flex-column flex-md-row justify-content-center align-items-center gap-3'>
                        ...
                        <Link to='/signup' className='text-primary fw-medium' style={{ textDecoration: "none" }}>Try Kite Demo <i className="fa-solid fa-arrow-right"></i></Link>
                    </div>
                </div>
            </div>
        </div>

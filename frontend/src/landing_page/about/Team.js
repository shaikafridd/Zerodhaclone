        ...
        <div className='container p-3 p-md-5 mt-5 mb-5'>
            ...
            <div className='row text-muted fs-5' style={{ lineHeight: "1.8" }}>
                ...
                <div className='col-12 col-md-6 p-3 p-md-5'>
                    <p>Nithin bootstrapped and founded Aero in 2010 to overcome the hurdles he faced during his decade long stint as a trader. Today, Aero has changed the landscape of the Indian broking industry.</p>

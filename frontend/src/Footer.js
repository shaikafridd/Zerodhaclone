            ...
            <div className='container border-top mt-5'>
                <div className='row mt-5'>
                    <div className='col-12 col-md-3 mb-4 mb-md-0'>
                        ...
                        <p>&copy;2010 - 2026, Aero Broking Ltd.<br/>All rights reserved.</p>
                    </div>
                    ...
                    <div className='col-12 col-md-3 mb-4 mb-md-0 d-flex flex-column'>
                        ...
                        <Link to="">Aero Cares (CSR)</Link>
                        <Link to="">Aero.tech</Link>
                        <Link to="">Open source</Link>
                        <Link to="">Referral program</Link>
                    </div>
                </div>
                <div className='mt-5 text-muted' style={{ fontSize: "14px" }}>
                    <p>Aero Broking Ltd.: Member of NSE, BSE, MCX & MSEI – SEBI Registration no.: INZ000031633 CDSL/NSDL: Depository services through Aero Broking Ltd. – SEBI Registration no.: IN-DP-431-2019 Registered Address: Aero Broking Ltd., #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School, J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any complaints pertaining to securities broking please write to complaints@aero.com, for DP related to dp@aero.com. Please ensure you carefully read the Risk Disclosure Document as prescribed by SEBI | ICF</p>
